...
TEST_CASE("ImgTree::basic ctor render","[weight=1][part=ImgTree]"){
    ...
    PNG out = t1.Render();
    cout << out.getPixel(0,0)->h <<endl;
    cout << img.getPixel(0,0)->h <<endl;

    cout << out.getPixel(0,1)->h <<endl;
    cout << img.getPixel(0,1)->h <<endl;

    cout << out.getPixel(0,2)->h <<endl;
    cout << img.getPixel(0,2)->h <<endl;

    cout << out.getPixel(0,3)->h <<endl;
    cout << img.getPixel(0,3)->h <<endl;

    cout << out.getPixel(1,3)->h <<endl;
    cout << img.getPixel(1,3)->h <<endl;
